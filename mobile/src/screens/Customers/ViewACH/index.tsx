...
type Props = NativeStackScreenProps<RootStackParamList, 'ViewACH'>;

const ViewACH = ({route, navigation}: Props) => {
          ...
          {!loading ? (
            <>
              ...
              <View style={tw`flex-row justify-between mt-5`}>
                ...
                <Text style={tw`text-gray-900 font-medium text-sm font-inter`}>
                  {token.account_type ? capitalize(token.account_type) : '-'}
                </Text>
              </View>
              <View style={tw`flex-row justify-between mt-5`}>
                <Text style={tw`text-gray-600 font-normal text-sm font-inter`}>
                ...
                <Text style={tw`text-gray-900 font-medium text-sm font-inter`}>
                  {token.account_type
                    ? capitalize(
                        token.ach_sec_code === 'CCD' ? 'Business' : 'Personal',
                      )
                    : '-'}
                </Text>
              </View>
              ...
              <View style={tw`flex-row justify-between mt-5`}>
                ...
                <View style={tw`flex-row`}>
                  ...
                  <Text
                    style={tw`text-gray-900 font-medium text-sm font-inter ml-0.2`}>
